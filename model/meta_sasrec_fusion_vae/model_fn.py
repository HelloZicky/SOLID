...
@model("meta_sasrec_fusion_vae", MetaType.ModelBuilder)
class SasRec(nn.Module):
    def __init__(self, model_conf):
        ...
        self._meta_classifier_param_list = common.HyperNetwork_FC_Fusion_VAE(
            model_conf.id_dimension,
    ...
    def forward(self, item_features, category_features, norm=0.01, fig1=False):
        ...
        user_embedding = self._meta_classifier_param_list(item_user_state, item_hist_embed,
        ...
        return torch.sum(user_embedding * item_target_embed, dim=1, keepdim=True), item_target_embed
