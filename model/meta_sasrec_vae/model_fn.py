...
@model("meta_sasrec_vae", MetaType.ModelBuilder)
class SasRec(nn.Module):
    def __init__(self, model_conf):
        ...
        self._meta_classifier_param_list = common.HyperNetwork_FC_VAE(
            model_conf.id_dimension,
    ...
    def forward(self, features, fig1=False):
        ...
        return torch.sum(user_embedding * target_embed, dim=1, keepdim=True), target_embed
