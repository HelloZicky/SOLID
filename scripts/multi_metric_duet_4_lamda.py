...
TYPE_LIST = [
    # "base", "base_finetune", "apg", "duet", "duet_vqvae", "fusion_category",
    #          "apg_id", "apg_id_vqvae",
    #          "apg_text", "apg_image", "apg_text_image", "apg_id_text", "apg_id_image",
    #          "apg_id_text_image", "apg_id_text_image_vqvae",
    #          "id", "id_vqvae", "id_vqvae_0.1_1", "id_vqvae_0.1_0.1", "id_vqvae_0.1_0.01", "id_vqvae_0.1_0.001",
             "id_vqvae_1_0.01", "id_vqvae_0.1_0.01", "id_vqvae_0.01_0.01", "id_vqvae_0.001_0.01",
...
NAME_LIST = [
    # "Base", "Finetune", "APG", "DUET", "DUET_VQVAE", "Fusion_Category",
    #          "APG_ID", "APG_ID_VQVAE",
    #          "APG_TEXT", "APG_IMAGE", "APG_TEXT_IMAGE", "APG_ID_TEXT", "APG_ID_IMAGE",
    #          "APG_ID_TEXT_IMAGE", "APG_ID_TEXT_IMAGE_VQVAE",
    #          "ID", "ID_VQVAE", "ID_VQVAE_0.1_1", "ID_VQVAE_0.1_0.1", "ID_VQVAE_0.1_0.01", "ID_VQVAE_0.1_0.001",
...
result_file = os.path.join(ROOT_FOLDER, "result_4_lamda.txt")
result_csv = os.path.join(ROOT_FOLDER, "result_4_lamda.csv")
