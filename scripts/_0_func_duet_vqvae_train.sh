...
######################################################################
LEARNING_RATE=0.001
CHECKPOINT_PATH=../checkpoint/MM2024/${dataset}_${model}/duet_vqvae
######################################################################
...
USER_DEFINED_ARGS="--model=meta_${model}_vqvae --num_loading_workers=1 --arch_config=${ARCH_CONFIG_CONTENT} --learning_rate=${LEARNING_RATE} \
...
python ../main/multi_metric_meta_vqvae_train.py \
--dataset=${data} \
${USER_DEFINED_ARGS}
