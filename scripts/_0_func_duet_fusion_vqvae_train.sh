...
######################################################################
LEARNING_RATE=0.001
CHECKPOINT_PATH=../checkpoint/MM2024/${dataset}_${model}/id_vqvae
# CHECKPOINT_PATH=../checkpoint/MM2024/${dataset}_${model}/id_text_image_vqvae
pretrain_model_path=../checkpoint/MM2024/${dataset}_${model}/category/duet/best_auc.pkl
######################################################################
...
USER_DEFINED_ARGS="--model=meta_${model}_fusion_vqvae --num_loading_workers=1 --arch_config=${ARCH_CONFIG_CONTENT} --learning_rate=${LEARNING_RATE} \
