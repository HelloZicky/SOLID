...
DATASET_LIST = ["amazon_scientific_subset", "douban_book", "douban_music", "amazon_cds", "amazon_electronic", "movielens_1m"]
...
result_file = os.path.join(ROOT_FOLDER, "result_1_main_2.txt")
result_csv = os.path.join(ROOT_FOLDER, "result_1_main_2.csv")
                        ...
                        with open(log_file, "r+") as reader:
                            ...
                            for key, value in result_dict.items():
                                ...
                                for _writer in [writer, csv_writer]:
                                    print(
                                        "{}\t{}\t{}\t{}".format(
                                            "{:18s}".format(dataset), "{:8s}".format(model), "{:22s}".format(name),
                                            "\t".join(value)
                                        ), sep="\t", file=_writer
                                    )
                    else:
