...
TYPE_LIST = [
    ...
    #          "id", "id_vqvae",
    "id_vqvae_0.1_1", "id_vqvae_0.1_0.1", "id_vqvae_0.1_0.01", "id_vqvae_0.1_0.001",
    # "id_vqvae_1_0.01", "id_vqvae_0.01_0.01", "id_vqvae_0.001_0.01",
...
result_file = os.path.join(ROOT_FOLDER, "result_5_t.txt")
result_csv = os.path.join(ROOT_FOLDER, "result_5_t.csv")
