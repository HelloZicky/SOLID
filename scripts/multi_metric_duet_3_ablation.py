...
if mode == "DUET":
    TYPE_LIST = [
                 # "apg_id_vqvae", "apg_id_text_image_vqvae",
                 # "apg_id", "apg_image", "apg_text", "apg_id_image", "apg_id_text", "apg_text_image", "apg_id_text_image",
                 # "id_vqvae", "id_text_image_vqvae",
                 "id", "image", "text", "id_image", "id_text", "text_image", "id_text_image",
                 ]
elif mode == "APG":
    TYPE_LIST = [
                 # "apg_id_vqvae", "apg_id_text_image_vqvae",
...
result_file = os.path.join(ROOT_FOLDER, "result_3_ablation_{}.txt".format(mode))
result_csv = os.path.join(ROOT_FOLDER, "result_3_ablation_{}.csv".format(mode))
