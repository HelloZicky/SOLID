...
######################################################################
LEARNING_RATE=0.001
CHECKPOINT_PATH=../checkpoint/MM2024/${dataset}_${model}/apg_id
######################################################################
...
USER_DEFINED_ARGS="--model=meta_${model}_apg_fusion --num_loading_workers=1 --arch_config=${ARCH_CONFIG_CONTENT} --learning_rate=${LEARNING_RATE} \
