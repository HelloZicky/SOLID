...
DATASET_LIST = ["amazon_arts_subset", "amazon_instruments_subset", "amazon_cds", "amazon_electronic", "movielens_1m"]

MODEL_LIST = ["din", "gru4rec", "sasrec", "bert4rec"]

# TYPE_LIST = ["base", "base_finetune", "duet"]
# TYPE_LIST = ["base", "base_finetune", "duet", "duet_fusion"]
TYPE_LIST = ["base", "base_finetune", "duet", "duet_vqvae",
             "id", "id_vqvae", "fusion_category", "text", "image", "text_image", "id_text", "id_image", "id_text_image",
             "id_text_image_vqvae",
             "apg", "apg_id", "apg_text", "apg_image", "apg_text_image", "apg_id_text", "apg_id_image",
             "apg_id_text_image",
             ]
...
NAME_LIST = ["Base", "Finetune", "DUET", "DUET_VQVAE",
             "ID", "ID_VQVAE", "Category_Item", "TEXT", "IMAGE", "TEXT_IMAGE", "ID_TEXT", "ID_IMAGE", "ID_TEXT_IMAGE",
             "ID_TEXT_IMAGE_VQVAE",
             "APG", "APG_ID", "APG_TEXT", "APG_IMAGE", "APG_TEXT_IMAGE", "APG_ID_TEXT", "APG_ID_IMAGE",
             "APG_ID_TEXT_IMAGE",
             ]
...
result_file = os.path.join(ROOT_FOLDER, "result_overall.txt")
result_csv = os.path.join(ROOT_FOLDER, "result_overall.csv")
